...
export default class QuestaoModel {
    ...
    static fromObj(obj: QuestaoModel): QuestaoModel {
        const respostas = obj.respostas.map(resp => RespostaModel.fromObj(resp))
    ...
    toObj() {
        return {
            ...
            respostas: this.#respostas.map(res => res.toObj())
        }
    }
}